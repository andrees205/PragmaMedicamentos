...
//    }
    ...
    int filaOriginal = jTable1.convertRowIndexToModel(filaSeleccionada);  // Convertir el índice de la fila seleccionada

    // Obtener el objeto Medicina de la lista original utilizando el índice convertido
    Medicamento medicinaSeleccionada = this.listaMedicinas.get(filaOriginal);

    // Pasar el objeto Medicina al formulario padre
    parentForm.setMedicina(medicinaSeleccionada);
    this.dispose();
