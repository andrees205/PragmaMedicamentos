...
public class LoteDAO {
    ...
    public ArrayList<Lote> ConsultarLotesVencidos() {
        ArrayList<Lote> listaLotes = new ArrayList<Lote>();
        String sSQL = "{CALL ObtenerLotesCaducados()};";
    ...
    public ArrayList<Lote> ConsultarLotesAgotados() {
        ArrayList<Lote> listaLotes = new ArrayList<Lote>();
        String sSQL = "{CALL ObtenerLotesExcedidos()};";
